# -*- coding: utf-8 -*-
"""
Created on Tue Mar 23 23:09:21 2021
...
data = np.loadtxt(open("E:/学校文件/论文/paper/data/new_data/2-ACE-antioxidative_315.csv"),delimiter=",",skiprows=1)
data_p=np.loadtxt(open("E:/学校文件/论文/paper/data/新建文件夹/antioxidative_ACE_inhibitor_35.csv"),delimiter=",",skiprows=1)
data_x=data[:,0:4]
data_y=data[:,4]
...
print(data_yp)
print(data_xp)
train_X, test_X , train_y , test_y = train_test_split(data_x,data_y,test_size=0.2,random_state=23)
...
ax.set_ylabel('Y')
ax.set_xlabel('X')
ax.view_init(elev=150, azim=150)
plt.show()
