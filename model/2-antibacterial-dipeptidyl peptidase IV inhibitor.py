# -*- coding: utf-8 -*-
"""
Created on Sat Mar 27 22:28:01 2021
...
data = np.loadtxt(open("E:/学校文件/论文/paper/data/new_data/2-dipeptidyl peptidase IV inhibitor-antibacterial_315.csv"),delimiter=",",skiprows=1)
data_p=np.loadtxt(open("E:/学校文件/论文/paper/data/新建文件夹/dipeptidyl peptidase IV inhibitor_antibacterial_35.csv"),delimiter=",",skiprows=1)
data_x=data[:,0:2]
data_y=data[:,4]
...
train_X, test_X , train_y , test_y = train_test_split(data_x,data_y,test_size=0.2,random_state=34)
...
knn = KNeighborsClassifier(n_neighbors = 29,weights='distance',metric = 'euclidean',algorithm="auto")# 定义一个knn分类器对象
...
plt.show()
#绘制散点分布图
plt.scatter(data_x[316:630,0], y=data_x[316:630,2],c="b",alpha=0.2,cmap='viridis')
plt.scatter(data_x[0:315,0], y=data_x[0:315,2],c="g",alpha=0.2,cmap='viridis')
plt.xlabel("")
plt.ylabel("")
...
ax.scatter(data_x[0:315,2], ys=data_x[0:315,1],zs=data_x[0:315,0],c="g")
