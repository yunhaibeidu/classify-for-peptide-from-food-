# -*- coding: utf-8 -*-
"""
Created on Sat Mar 27 21:10:12 2021
...
print(len(test_X))
#knn kdtree
knn = KNeighborsClassifier(n_neighbors =28 ,weights='distance',metric = 'chebyshev',algorithm="auto")# 定义一个knn分类器对象
...
plt.show()
#绘制散点分布图
a=plt.scatter(data_x[316:629,1], y=data_x[316:629,0],c="b",alpha=0.2,cmap='viridis',label="antioxdative")
b=plt.scatter(data_x[0:315,1], y=data_x[0:315,0],c="r",alpha=0.2,cmap='viridis',label="ipeptidyl peptidase IV inhibitor")
plt.xlabel("SP3")
plt.ylabel("SP2")
plt.legend()
plt.title("dipeptidyl peptidase IV inhibitor-antioxdative")
plt.show
#绘制三维情况下的散点分布
fig = plt.figure()
ax = fig.add_subplot(111, projection='3d')
ax.scatter(data_x[316:630,2], ys=data_x[316:630,1],zs=data_x[316:630,3],c="g") # 绘制数据点
ax.scatter(data_x[0:315,2], ys=data_x[0:315,1],zs=data_x[0:315,3],c="r")
